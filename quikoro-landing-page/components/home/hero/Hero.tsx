...
export default function Hero() {
  return (
    <section className="w-full p-4 lg:p-10 xl:px-20">
      <section
      ...
      >
        <Header />
        <div className="w-full max-w-7xl relative mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-0 items-center px-5 pt-20">
          {/* ============ LEFT: COPY ============ */}
