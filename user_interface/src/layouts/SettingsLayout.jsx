  ...
  return (
    <div className="rounded-[2.5rem] foreground overflow-hidden w-full flex-1 flex flex-col">
      ...
      <div className="px-5 lg:px-8 pt-8 pb-8">
        <h1 className="text-[24px] lg:text-[36px] font-bold tracking-tight text-gray-900 mb-2">
          Settings
        </h1>

        <p className="lg:text-[18px] text-gray-500 font-medium">
      ...
      <div className="flex flex-col md:flex-row flex-1">
        ...
        <div className="flex-1 px-5 lg:px-8 py-5 lg:py-10 foreground">
          {children}
        </div>
      </div>
    </div>
